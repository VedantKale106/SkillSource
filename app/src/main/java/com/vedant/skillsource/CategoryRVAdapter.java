...
public class CategoryRVAdapter extends ListAdapter<Category, CategoryRVAdapter.ViewHolder> {
    ...
    private static final DiffUtil.ItemCallback<Category> DIFF_CALLBACK = new DiffUtil.ItemCallback<Category>() {
        ...
        public boolean areContentsTheSame(Category oldItem, Category newItem) {
            ...
            return oldItem.getcategoryName().equals(newItem.getcategoryName()) &&
                    oldItem.getcategoryDescription().equals(newItem.getcategoryDescription()) &&
                    oldItem.getcategoryRates().equals(newItem.getcategoryRates());
        }
    };
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Category model = getCourseAt(position);
        holder.courseNameTV.setText(model.getcategoryName());
        holder.courseDescTV.setText(model.getcategoryDescription());
        holder.courseDurationTV.setText("Rate - " + model.getcategoryRates());
    }

    // creating a method to get course modal for a specific position. 
    public Category getCourseAt(int position) {
